...
(function () {
  ...
  Game_Action.prototype.prepare = function () {
    ...
    if (
      ...
      (String(Moghunter.bhud_face_animated) === "true" ||
        String(Moghunter.bhud_face_zoom) === "true")
    ) {
  ...
  //==============================
  const _Battle_Hud_need_refresh_states2 =
    Battle_Hud.prototype.need_refresh_states2;
    ...
    if ($gameTemp._bhud_position_active) {
      ...
      if ($gameTemp._bhud_auto_com) {
        if (
          ...
          this.yp = $gameTemp._bhud_position_active[1];
          this.org[0] =
            $gameTemp._bhud_position_active[0] + Moghunter.bhud_com_x;
          if (this._com_mode === 0) {
            this.org[1] =
              $gameTemp._bhud_position_active[1] +
              Moghunter.bhud_com_y -

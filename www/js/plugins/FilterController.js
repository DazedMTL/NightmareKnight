...
(function () {
      ...
      case "CREATEFILTER":
        ...
        if (args.length > 3) {
          if (args[3] === "screen") char = 0;
            ...
            char = Number(args[3]);
            if (char === 0) {
              // this event/battle unit
              if (!$gameParty.inBattle()) char = this._eventId || 0;
              else {
                var sub = BattleManager._subject,
                  index = 0;
                if (sub) {
  ...
  Filter_Controller.prototype.createFilter = function () {
    ...
    if (Filter_Controller.filterNameMap[this._filterType]) {
      if (
        Filter_Controller.filterNameMap[this._filterType] ===
        PIXI.filters.DisplacementFilter
      )
        filter = this.createDisplacement();
      else filter = new Filter_Controller.filterNameMap[this._filterType]();
    }
  ...
  Filter_Controller.prototype.getCharLoc = function () {
    ...
    if (!!this._charMapId) {
      ...
      var char;
      if (this._character < 0)
        char = BattleManager._spriteset._enemySprites[-this._character - 1];
  ...
  Game_Map.prototype.createFilter = function (id, filter, targetObj, char) {
    ...
    var f = new Filter_Controller(
      filter,
      id,
      targetObj,
      char,
      typeof char === "number" && !$gameParty.inBattle()
        ? this.mapId()
        : undefined
    );
  ...
  Scene_Base.prototype.applyTKMFilter = function (filter, targetObj) {
    var arr,
      targets = this.getTKMFilterObj(targetObj);
    for (var i = 0; i < targets.length; i++) {
      ...
      if (
        targetObj === 2 ||
        targetObj === 3 ||
        filter instanceof PIXI.filters.BulgePinchFilter ||
        targetObj === 21 ||
        targetObj === 31
      ) {
        var margin = 0;
  ...
  Scene_Base.prototype.getTKMFilterObj = function (targetObj) {
    ...
    if (targetObj >= 3990 && targetObj <= 4999) {
      ...
      if (index < 0) {
        if (charSprites[charSprites.length + index])
          targets.push(charSprites[charSprites.length + index]);
      } else if (index > 0) {
        if (
          charSprites[index - 1] &&
          charSprites[index - 1]._character &&
          ...
          if (!!this._spriteset) {
            if (!!this._spriteset._tilemap) {
              targets = [
                ...
                this._spriteset._tilemap.upperZLayer,
              ];
            }
          }
          break;
    ...
    Xe = (function (e) {
      function n(n, r, o, i) {
        void 0 === n && (n = 100),
          ...
          (this.uniforms.texSize = new t.Point(1024, 1024)),
          this.updateDelta();
      }
      e && (n.__proto__ = e),
        (n.prototype = Object.create(e && e.prototype)),
...
!(function (n, e) {
  "object" == typeof exports && "undefined" != typeof module
    ? e(exports, require("pixi.js"))
    : "function" == typeof define && define.amd
    ? define(["exports", "pixi.js"], e)
    : e((n.__filters = {}), n.PIXI);
})(this, function (n, e) {
  "use strict";
  var t =
      "attribute vec2 aVertexPosition;\nattribute vec2 aTextureCoord;\n\nuniform mat3 projectionMatrix;\n\nvarying vec2 vTextureCoord;\n\nvoid main(void)\n{\n    gl_Position = vec4((projectionMatrix * vec3(aVertexPosition, 1.0)).xy, 0.0, 1.0);\n    vTextureCoord = aTextureCoord;\n}",
    ...
    r = (function (n) {
      function r(r) {
        n.call(this, t, o.replace("${perlin}", i)),
          (this.uniforms.dimensions = new Float32Array(2)),
          "number" == typeof r &&
            (console.warn(
            ...
            (r = { angle: r }),
            void 0 !== arguments[1] && (r.gain = arguments[1]),
            void 0 !== arguments[2] && (r.lacunarity = arguments[2]),
            void 0 !== arguments[3] && (r.time = arguments[3]),
            void 0 !== arguments[4] && (r.strength = arguments[4])),
          (r = Object.assign(
            {
              angle: 30,
              gain: 0.5,
          ...
          (this._angleLight = new e.Point()),
          (this.angle = r.angle),
          (this.gain = r.gain),
          (this.lacunarity = r.lacunarity),
          (this.parallel = r.parallel),
      ...
      return (
        (r.prototype.apply = function (n, e, t, i) {
          var o = e.sourceFrame,
            r = o.width,
            a = o.height;
          (this.uniforms.light = this.parallel
  ...
  (n.GodrayFilter = r), Object.defineProperty(n, "__esModule", { value: !0 });
}),

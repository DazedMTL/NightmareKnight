...
(function () {
  ...
  Game_Actor.prototype.enableSkills = function () {
    ...
    return this._enableSkills.reduce(function (r, id) {
      return r.concat([$dataSkills[id]]);
    }, []);
  };
  ...
  Game_Actor.prototype.learnSkill = function (skillId) {
    ...
    if (!(Imported["VXandAceHybridClass"] || Imported.YEP_ClassChangeCore))
      this.refresh();
  };

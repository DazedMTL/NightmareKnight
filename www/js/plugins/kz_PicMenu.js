...
(function () {
  ...
  var _cmdlistTxt = [
    ...
    "equip:" + _equipicon,
    "status:" + _statusicon,
    "formation:" + _formationicon,
    "options:" + _optionsicon,
    "save:" + _saveicon,
    "gameEnd:" + _endicon,
    "default:-1",
  ];
  ...
  var kz_Window_MenuCommand_prototype_initialize =
  ...
  Window_MenuCommand.prototype.drawItem = function (index) {
    ...
    var properIndex =
      _cmdlist[symbol] >= 0 ? _cmdlist[symbol] : _cmdlist["default"];
  ...
  Window_MenuCommand.prototype.drawMenuIcon = function (
    iconIndex,
    x,
    y,
    selected
    ...
    if (selected) {
      var expScale =
        1 + Math.sin(((this._stayCount % 60) / 60) * Math.PI) * _MaxExpansion;
  ...
  kz_Window_MenuCommand_prototype_itemRect =
    Window_MenuCommand.prototype.itemRect;
  Window_MenuCommand.prototype.itemRect = function (index) {
    ...
    rect.x += _xOverhead;
    rect.y =
      Math.floor(index / maxCols) * (rect.height + _IconitemRect) -
      this._scrollY +
      _yOverhead;
    return rect;
  };
  ...
  var kz_Window_MenuCommand_prototype_isCursorVisible =
    Window_MenuCommand.prototype.isCursorVisible;
